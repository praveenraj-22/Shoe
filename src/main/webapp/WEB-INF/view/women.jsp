			...
			<div class="col-sm-6">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<center>
							<img src="resources/image/aWWwIeeY_400x400.png"
					...
					<springForm:form action="${url}" modelAttribute="productObj"
						...
						<div class="form-group">
							<springForm:label class="control-label col-sm-3" path="category">Select Category :</springForm:label>
							<div class="col-sm-8">
								<c:forEach items="${categories }" var="c">
									<springForm:radiobutton class="form-control" path="category.id"
