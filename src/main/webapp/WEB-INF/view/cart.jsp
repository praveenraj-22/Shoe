...
<tr>
<td> <font color="black">${cartItem.product.productname}</font></td>

<td><font color="black">${cartItem.quantity}</font></td>
<td><font color="black">${cartItem.totalPrice}</font></td>
...
<td></td>
 ...
 <font color="green">Total Price :${grandTotal }</font>
</div>
